...
const ContactPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const mailtoURL = `mailto:info@ppdsanalytics.com?subject=Contact from ${encodeURIComponent(
      name
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            >
              ...
              <button
                type="submit"
                className="w-full block bg-green-600 text-white text-center px-4 py-2 rounded-lg hover:bg-green-700"
              >
                Send Message
              </button>
            </form>
          ...
          <div>
            ...
            <p className="mb-4">
              ...
              services, need support, or want to collaborate, we are ready to
              assist you.
            </p>
            <div className="bg-white shadow-md rounded-lg p-6">
              ...
              <div className="mb-4 flex items-center space-x-3">
                ...
                <p className="text-gray-600">
                  Suite 3, Block 5, Zone D Extension, Central Market, OAU,
