...
const ServicesCard = () => {
  return (
    <div className="py-8 px-4">
      <h2 className="text-2xl md:text-2xl lg:text-3xl font-bold mb-6 text-blue-500">Our Services</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((feature, index) => (
          <div
            key={index}
            className="bg-white shadow-md rounded-md p-4 flex flex-col lg:items-start items-center"
          >
            <div className="bg-blue-500 text-white flex items-center justify-center rounded-full mb-3 
            ...
            <p className="text-gray-600 text-sm md:text-[12px] text-center lg:text-left">
              {feature.description}
            </p>
          </div>
        ))}
